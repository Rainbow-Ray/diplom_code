...
@section('title')
    <title>Редактировать закупку</title>
@endsection
...
@section('scripts')
    ...
    <script src=" {{ asset('assets/js/select2.min.js') }}"></script>
    <script src=" {{ asset('assets/js/request.purchase/purchaseEdit.js') }}" type="module"></script>
...
@section('main')
    <form action="/{{ $rootURL }}" method="POST">
        ...
        <h3 class="editHeader  hide start1 end7">Добавить купленный по запросу товар:</h3>
                ...
                <p class="start1 end7 noMargin">Добавить материал или оборудование:</p>
        ...
        <input type="button" class="formButton leftButton beautyButton start5 hide" value="Отмена" id="cancelEdit">
        <input type="button" class="formButton leftButton addButton beautyButton start6 end7 hide"
            value="Добавить товар" id="editSave">

        <input type="button" class="formButton leftButton addButton beautyButton start6 end7" value="Добавить"
            id="itemAdd">
            ...
            <table class="itemTable">
                ...
                <tbody class="itemPurchasedTbody">
                    ...
                    @foreach ($item->rows as $row)
                        <x-item-row :item="$row" :purchased="0" />
                    @endforeach
