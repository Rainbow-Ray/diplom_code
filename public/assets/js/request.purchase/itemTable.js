...
class item {
    ...
    formatRow(){
        return `<tr>
            <td><input type='text' name='itemCheck[].Key' class='hide check `+ this.prefId + `' id='item` + this.prefId + `' value='` + this.value + `' readonly>
            <input type='text' name='itemCheck[].Value' class='hide `+ this.prefId + `' value='`+ this.printCountEiPrice()+`'>
